...
class Page:
    ...
    def protection(self) -> Dict[str, Any]: ...  # FIXME
    @property
...
class User(Page):
    ...
    def gender(self, force: bool = False) -> Union[Literal["male", "female", "unknown"]]: ...
    def getprops(self, force: bool = False) -> Dict[str, Any]: ...  # FIXME
